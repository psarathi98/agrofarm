    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
        ...
        <p href="#">Follow Us on <span aria-hidden="true">&rarr;</span></p>
          <a href="https://m.facebook.com/profile.php?id=100085618403492">Facebook </a>
          <a href="https://wa.me/+916295058389">Whatsapp </a>
        </div>
...
<!---reviews end--->
  ...
  <section class="bg-gray-100" id="contactus"  data-aos="zoom-in"  data-aos-duration="1000"  >
    <div id="contactus" class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
        <div class="max-w-2xl lg:max-w-4xl mx-auto text-center">
            <h2 class="text-3xl font-extrabold text-gray-900">Want to experience the whole process?</h2>
            <p class="mt-4 text-lg text-gray-500">Visit us at the location.</p>
        </div>
