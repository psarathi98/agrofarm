...
<?php
$user = 'u161634348_agrofarm';
$password = 'abAgro_farm@11';

// Database name is geeksforgeeks
$database = 'u161634348_adminrecord';
        ...
        if(in_array($fileType, $allowTypes)){ 
            ...
            if($insert){ 
              echo"<script type='text/javascript'>alert('File uploaded successfully!!.');
                ...
                echo "<script type='text/javascript'>alert('File uploaded failed please try again!!.');
        </script>";
            }  
        }else{ 
            echo "<script type='text/javascript'>alert('Sorry, only JPG, JPEG, PNG, & GIF files are allowed to upload..');
        </script>";
        } 
    }else{ 
        echo "<script type='text/javascript'>alert('please choose an image file to upload!!.');
        </script>";
    } 
} 
